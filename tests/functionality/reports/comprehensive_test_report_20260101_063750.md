...
**Generated**: 2026-01-01 06:37:50 UTC
...
- **Status**: FAIL
- **Duration**: 121901.59ms
- **Tests**: 11 (Passed: 7, Failed: 1)
...
### base_url_connectivity (delta exchange connection)
...
**Issue**: Redis connection failed: Timeout connecting to server
