...
class Trade(Base):
    ...
    side = Column(PostgresEnum(TradeSide, name='tradeside', create_type=True), nullable=False)
...
class Position(Base):
    ...
    realized_pnl = Column(DECIMAL(18, 8), nullable=True, default=Decimal("0"))
...
class Decision(Base):
    ...
    symbol = Column(String(50), nullable=False, index=True)
    signal = Column(PostgresEnum(SignalType, name='signaltype', create_type=True), nullable=False)
